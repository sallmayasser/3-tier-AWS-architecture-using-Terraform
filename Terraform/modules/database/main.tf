...
locals {
  ...
  mongo_uri = "mongodb://${var.db_username}:${var.db_password}@${aws_docdb_cluster.docdb.endpoint}:27017/?tls=true&tlsCAFile=/home/ubuntu/rds-combined-ca-bundle.pem&replicaSet=rs0&retryWrites=false"
}


# /////////////////////// Creating SSM parameter for MongoDb URL //////////////////
